	...
	<div class="container">
		<div class="profile">
			...
			<div class="profile-user-settings">
                ...
                <a href="update_profile.php">Profili duzenle</a></h1>
			<h1>	 </h1>
        ...
        $gonderipaycek = $kisibilgisi->fetch_assoc();
            if($stmt = $conn->query("SELECT * FROM   `galery`"))
            {
                ...
                while ($row = $stmt->fetch_assoc()) 
                {
                    ...
                    if($row['kim'] == $_GET['profilcek'])
                    {
                        $sil = "<li class='gallery-item-likes'><h1><button type='submit' name='submit_sil' class='btn'</button>sil</h1></li> ";
